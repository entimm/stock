...
def cal_new_high(year):
    ...
    for symbol in symbols:
        ...
        one_df[f'lowest'] = one_df['open'].rolling(window=20).min()
        ...
        for symbol, stock_df in stock_data.items():
            ...
            if not idx.empty:
                if stock_df.loc[idx, 'new_high'].values[0]:
                    ...
                    value = (stock_df.loc[idx, f'highest'].values[0] - stock_df.loc[idx, f'lowest'].values[0]) / stock_df.loc[idx, f'lowest'].values[0] * 100
