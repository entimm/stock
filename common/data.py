...
from common.common import GNBK_FILE_PATH, STOCK_META_FILE_PATH, ETF_FILE_PATH, TDX_PATH, NORTH_FUNDS_FILE_PATH
...
trade_date_list = local_tdx_reader.daily(symbol='999999').reset_index().tail(100)['date'].to_list()